...
public class UserController {
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Success OTP Confirmation", content = {
                                        @Content(mediaType = "application/json", schema = @Schema(implementation = ConfirmOTPResponse.class))
                        }),
                        @ApiResponse(responseCode = "403", description = "Invalid OTP Exception", content = {
                                        @Content(mediaType = "application/json", schema = @Schema(implementation = ConfirmOTPResponse.class))
                        }),
                        @ApiResponse(responseCode = "403", description = "Expired OTP Exception", content = {
                                        @Content(mediaType = "application/json", schema = @Schema(implementation = ConfirmOTPResponse.class))
                        }),
        })
        @PostMapping(value = "/confirm-otp", consumes = { MediaType.APPLICATION_JSON_VALUE })
        public ConfirmOTPResponse confirmOtp(
                ...
                return new ConfirmOTPResponse(true, "OTP Benar");
        }
